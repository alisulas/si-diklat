...
class Agenda extends CI_Controller
{
    ...
    protected function get_index($offset)
    {
        ...
        // $fieldku = $this->db->list_fields('plc_trans_pelatihan');
        // $fieldku = $this->db->query('SELECT * FROM plc_trans_pelatihan');
        $fieldku = $this->db->list_tables('user');
