...
$this->fpdf->Cell(20,5,'Number'); $this->fpdf->Cell(5,5,':'); $this->fpdf->Cell(20,5,$data['gl']['no_gl']);
$this->fpdf->Ln();
$this->fpdf->Cell(20,5,'Date');$this->fpdf->Cell(5,5,':');$this->fpdf->Cell(20,5,$this->editor->date_correct($data['gl']['tanggal']));
$this->fpdf->Ln();
$this->fpdf->Cell(20,5,'To');$this->fpdf->Cell(5,5,':');$this->fpdf->Cell(95,5,$data['gl']['kepada'],1,0,'L');
$this->fpdf->Cell(5,5,' ');
$this->fpdf->Cell(20,5,'No Fax');$this->fpdf->Cell(5,5,':');$this->fpdf->Cell(35,5,$data['gl']['no_fax'],1,0,'L');
$this->fpdf->Ln(6);
$this->fpdf->Cell(20,5,'From');$this->fpdf->Cell(5,5,':');$this->fpdf->Cell(95,5,$data['gl']['dari'],1,0,'L');
$this->fpdf->Cell(5,5,' ');
$this->fpdf->Cell(20,5,'No Fax');$this->fpdf->Cell(5,5,':');$this->fpdf->Cell(35,5,$data['gl']['no_fax'],1,0,'L');
$this->fpdf->Ln();
...
$this->fpdf->Ln(9);
$this->fpdf->Cell(20,5,'Title');$this->fpdf->Cell(5,5,':');$this->fpdf->Cell(105,5,$data['gl']['judul_program'],1,0,'L');
$this->fpdf->Cell(5,5,' ');
$this->fpdf->Cell(10,5,'Code');$this->fpdf->Cell(5,5,':');$this->fpdf->Cell(35,5,$data['gl']['kode_program'],1,0,'L');
$this->fpdf->Ln(6);
$this->fpdf->Cell(20,5,'Dates ');$this->fpdf->Cell(5,5,':');$this->fpdf->Cell(30,5,  $this->editor->date_correct($data['gl']['tgl_pelaksanaan']),1,0,'L');
$this->fpdf->Cell(20,5,'Times ',0,0,'C');$this->fpdf->Cell(5,5,':');$this->fpdf->Cell(50,5,$data['gl']['waktu'],1,0,'L');
$this->fpdf->Cell(20,5,'Duration',0,0,'C');$this->fpdf->Cell(5,5,':');$this->fpdf->Cell(20,5,$data['gl']['durasi'].' Hari',1,0,'L');
$this->fpdf->Ln(6);
$this->fpdf->Cell(20,5,'Place');$this->fpdf->Cell(5,5,':');$this->fpdf->Cell(105,5,$data['gl']['tempat'],1,0,'L');
$this->fpdf->Ln(6);
$this->fpdf->Cell(20,5,'');$this->fpdf->Cell(5,5,':');$this->fpdf->Cell(20,5,$data['gl']['sifat'],1,0,'L');
$this->fpdf->Ln();
...
$this->fpdf->Ln();
$this->fpdf->Cell(33,5,'    Kapasitas'); $this->fpdf->Cell(5,5,':'); $this->fpdf->Cell(20,5,$data['gl']['rm_kapasitas']);
$this->fpdf->Ln();
$this->fpdf->Cell(33,5,'    Perlengkapan');$this->fpdf->Cell(5,5,':');$this->fpdf->Cell(20,5,$data['gl']['rm_perlengkapan']);
$this->fpdf->Ln();
$this->fpdf->Cell(33,5,'    Layout Ruangan');$this->fpdf->Cell(5,5,':');$this->fpdf->Cell(20,5,$data['gl']['rm_layout']);
$this->fpdf->Ln();
$this->fpdf->Cell(33,5,'    Keterangan');$this->fpdf->Cell(5,5,':');$this->fpdf->Cell(20,5,$data['gl']['rm_keterangan']);
$this->fpdf->Ln();
$this->fpdf->Ln();
$this->fpdf->Cell(20,5,'2. Business Center');
$this->fpdf->Ln();
$this->fpdf->Cell(33,5,'    Ukuran Ruangan'); $this->fpdf->Cell(5,5,':'); $this->fpdf->Cell(20,5,$data['gl']['bc_ukuran_ruangan']);
$this->fpdf->Ln();
$this->fpdf->Cell(33,5,'    Perlengkapan');$this->fpdf->Cell(5,5,':');$this->fpdf->Cell(20,5,$data['gl']['bc_perlengkapan']);
$this->fpdf->Ln();
$this->fpdf->Cell(33,5,'    Keterangan');$this->fpdf->Cell(5,5,':');$this->fpdf->Cell(20,5,$data['gl']['bc_keterangan']);
$this->fpdf->Ln();
$this->fpdf->Ln();
$this->fpdf->Cell(20,5,'3. Akomodasi (Khusus Residensial)');
$this->fpdf->Ln();
$this->fpdf->Cell(33,5,'    => Peserta'); $this->fpdf->Ln(); 
$this->fpdf->Cell(35,5,'        Jumlah Kamar : ');$this->fpdf->Cell(10,5,$akomodasi_peserta[0],1,'','C');
$this->fpdf->Cell(13,5,' Type : ');$this->fpdf->Cell(15,5,$akomodasi_peserta[1],1);
$this->fpdf->Cell(18,5,' CheckIn : ');$this->fpdf->Cell(25,5,$this->editor->date_correct($akomodasi_peserta[2]),1);
$this->fpdf->Cell(20,5,' CheckOut : ');$this->fpdf->Cell(25,5,$this->editor->date_correct($akomodasi_peserta[3]),1);
$this->fpdf->Ln();
$this->fpdf->Cell(33,5,'    => Instruktur'); $this->fpdf->Ln(); 
$this->fpdf->Cell(35,5,'        Jumlah Kamar : ');$this->fpdf->Cell(10,5,$akomodasi_instruktur[0],1,'','C');
$this->fpdf->Cell(13,5,' Type : ');$this->fpdf->Cell(15,5,$akomodasi_peserta[1],1);
$this->fpdf->Cell(18,5,' CheckIn : ');$this->fpdf->Cell(25,5,$this->editor->date_correct($akomodasi_instruktur[2]),1);
$this->fpdf->Cell(20,5,' CheckOut : ');$this->fpdf->Cell(25,5,$this->editor->date_correct($akomodasi_instruktur[3]),1);
$this->fpdf->Ln();
$this->fpdf->Cell(35,5,'        Keterangan      :');$this->fpdf->Cell(150,5,$data['gl']['akomodasi_keterangan']);
$this->fpdf->Ln();
$this->fpdf->Ln();
$this->fpdf->Cell(20,5,'4. Konsumsi');
$this->fpdf->Ln();
$this->fpdf->Cell(33,5,'    a). Meal'); $this->fpdf->Ln(); 
$this->fpdf->Cell(28,5,'        Breakfast'); $this->fpdf->Cell(5,5,':'); $this->fpdf->Cell(100,5,$data['gl']['meal_breakfast']);
$this->fpdf->Ln();
$this->fpdf->Cell(28,5,'        Lunch');$this->fpdf->Cell(5,5,':');$this->fpdf->Cell(100,5,$data['gl']['meal_launch']);
$this->fpdf->Ln();
$this->fpdf->Cell(28,5,'        Dinner');$this->fpdf->Cell(5,5,':');$this->fpdf->Cell(100,5,$data['gl']['meal_dinner']);
$this->fpdf->Ln();
$this->fpdf->Cell(28,5,'        Keterangan');$this->fpdf->Cell(5,5,':');$this->fpdf->Cell(150,5,$data['gl']['konsumsi_ket']);
$this->fpdf->Ln();
$this->fpdf->Cell(33,5,'    b). Cofee Break'); $this->fpdf->Ln(); 
$this->fpdf->Cell(28,5,'        Jumlah'); $this->fpdf->Cell(5,5,':'); $this->fpdf->Cell(100,5,$data['gl']['cb_jumlah']);
$this->fpdf->Ln();
$this->fpdf->Cell(28,5,'        Frekuensi');$this->fpdf->Cell(5,5,':');$this->fpdf->Cell(100,5,$data['gl']['cb_frekuansi']);
$this->fpdf->Ln();
$this->fpdf->Cell(48,5,'        Waktu Pemberian');$this->fpdf->Cell(5,5,':');$this->fpdf->Cell(150,5,$data['waktu_pemberian']);
$this->fpdf->Ln();
$this->fpdf->Cell(48,5,'        Refreshment di Ruangan ');$this->fpdf->Cell(5,5,':');$this->fpdf->Cell(150,5,$data['refreshment']);
$this->fpdf->Ln();
$this->fpdf->Ln();
$this->fpdf->Ln();
$this->fpdf->Ln();
...
$this->fpdf->Ln();
$this->fpdf->Cell(40,5,'    Jenis Kendaraan'); $this->fpdf->Cell(5,5,':'); $this->fpdf->Cell(50,5,$data['gl']['trans_jenis_kendaraan']);
$this->fpdf->Ln();
$this->fpdf->Cell(40,5,'    Tanggal Penggunaan');$this->fpdf->Cell(5,5,':');$this->fpdf->Cell(50,5,$this->editor->date_correct($data['gl']['trans_tanggal']));
$this->fpdf->Ln();
$this->fpdf->Cell(40,5,'    Waktu Penggunaan');$this->fpdf->Cell(5,5,':');$this->fpdf->Cell(50,5,$data['gl']['trans_waktu']);
$this->fpdf->Ln();
$this->fpdf->Cell(20,5,'6. Training Kit');
$this->fpdf->Ln();
$this->fpdf->Cell(40,5,'    Tas Ransel'); $this->fpdf->Cell(5,5,':'); $this->fpdf->Cell(50,5,$data['gl']['tk_tas_ransel'].' pcs');
$this->fpdf->Ln();
$this->fpdf->Cell(40,5,'    Block Note');$this->fpdf->Cell(5,5,':');$this->fpdf->Cell(50,5,$data['gl']['tk_block_note'].' pcs');
$this->fpdf->Ln();
$this->fpdf->Cell(40,5,'    Ballpoint');$this->fpdf->Cell(5,5,':');$this->fpdf->Cell(50,5,$data['gl']['tk_ballpoint'].' pcs');
$this->fpdf->Ln();
$this->fpdf->Cell(40,5,'    Flashdisk');$this->fpdf->Cell(5,5,':');$this->fpdf->Cell(50,5,$data['gl']['tk_flashdisk'].' pcs');
$this->fpdf->Ln();
$this->fpdf->Cell(40,5,'    Keping CD');$this->fpdf->Cell(5,5,':');$this->fpdf->Cell(50,5,$data['gl']['tk_cd'].' pcs');
$this->fpdf->Ln();
$this->fpdf->Cell(40,5,'    Keping DVD');$this->fpdf->Cell(5,5,':');$this->fpdf->Cell(50,5,$data['gl']['tk_dvd'].' pcs');
$this->fpdf->Ln();
$this->fpdf->Cell(40,5,'    Lainnya');$this->fpdf->Cell(5,5,':');$this->fpdf->Cell(50,5,$data['gl']['tk_lainnya'].' pcs');
$this->fpdf->Ln();
$this->fpdf->Cell(40,5,'    Cost Center');$this->fpdf->Cell(5,5,':');$this->fpdf->Cell(50,5,$data['gl']['cost_center']);
$this->fpdf->Ln();
$this->fpdf->Cell(40,5,'    Cost Element');$this->fpdf->Cell(5,5,':');$this->fpdf->Cell(50,5,$data['gl']['cost_element']);
$this->fpdf->Ln();
