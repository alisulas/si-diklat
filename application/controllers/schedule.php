		...
		if ($id == null) {
			...
			if ($sch->num_rows() <= 0) {
				...
				$this->table->set_heading(
					array('data' => 'Waktu', 'width' => 80),
					array('data' => 'Hari 1', 'width' => 123),
					array('data' => 'Hari 2', 'width' => 123),
					array('data' => 'Hari 3', 'width' => 123),
					array('data' => 'Hari 4', 'width' => 123),
					array('data' => 'Hari 5', 'width' => 123),
					array('data' => 'Hari 6', 'width' => 123),
					array('data' => 'Hari 7', 'width' => 123)
				);
