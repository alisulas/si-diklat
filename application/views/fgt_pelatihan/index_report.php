...
<script type="text/javascript" language="javascript" src="assets/datatable/1.10.6/ext/dataTables.tableTools.js">
</script>
<p>
    ...
    <table>
        ...
        <tr>
            ...
            <td><input type="text" name="tgl_awal" id="tgl_awal" placeholder="Dari"> - <input type="text"
                    name="tgl_selesai" id="tgl_selesai" placeholder="Sampai"></td>
        </tr>
        <tr>
            <td></td>
        ...
        select: function(event, ui) {
            if (ui.item.id != 0) {
                ...
                $("#result_program").append(
                    ...
                    .item.value +
                    "&nbsp;<span class='label label-inverse'>Batch</span><input type='text' name='batch' class='input input-mini'>"
                );
                $("#program").hide();
            }
        }
