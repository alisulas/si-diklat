<table class="table table-condensed">
    ...
    <tr>
        <td>Kuota Kelas</td>
        <td>: <?php echo $detail['kuota_kelas']; ?></td>
    </tr>
    <tr>
    ...
    <tr>
        <td>Pengajar</td>
        <td>: <table border='1'><?php echo $pengajar; ?></table>
        </td>
    </tr>
    <tr>
        <td>Provider</td>
    ...
    <tr>
        <td>Observer</td>
        <td>: <table border='1'><?php echo $observer; ?></table>
        </td>
    </tr>
    <tr>
        <td>Input TEM</td>
        <td>: <?php echo $input_tem; ?></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>: <?php echo $nilai_evaluasi . '&nbsp;' . $download_evaluasi; ?></td>
    </tr>
    <tr>
        <td>SLA</td>
        <td>: <?php echo $sla; ?></td>
