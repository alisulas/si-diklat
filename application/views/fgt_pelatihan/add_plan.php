...
<table class="table table-bordered table-condensed">
    ...
    <tr>
        ...
        <td>
            ...
            <a href="pelatihan/add" class="btn btn-success" target="_blank" style="float:right">Tambah Pelatihan Baru
    ...
    <tr>
        ...
        <td class="left">
            <input type="text" name="ref_user">&nbsp;<input type="text" name="ref_memo"
                placeholder="No Memo">&nbsp;<input type="text" name="ref_tgl" id="ref_tgl" placeholder="Tanggal"><span
                style="color:red">*</span><i>Wajib di isi untuk perhitungan SLA</i><br>
            <input type="text" name="ref_hrbp">&nbsp;<input type="text" name="ref_hrbp_memo"
                placeholder="No Memo">&nbsp;<input type="text" name="ref_hrbp_tgl" id="ref_hrbp_tgl"
                placeholder="Tanggal">
        </td>
    </tr>
    <tr>
