...
<table class="table table-bordered table-condensed">
	...
	<td class="left">
            <input type="text" name="ref_user"  value="<?php echo $ref[0]; ?>">&nbsp;<input type="text" name="ref_memo" placeholder="No Memo" value="<?php echo $ref[1]; ?>">&nbsp;<input type="text" name="ref_tgl" id="ref_tgl" placeholder="Tanggal" value="<?php echo $ref[2];?>"><span style="color:red">*</span><i>Wajib di isi untuk perhitungan SLA</i><br>
            <input type="text" name="ref_hrbp" value="<?php echo $ref_hrbp[0]; ?>">&nbsp;<input type="text" name="ref_hrbp_memo" placeholder="No Memo" value="<?php echo $ref_hrbp[1]; ?>">&nbsp;<input type="text" name="ref_hrbp_tgl" id="ref_hrbp_tgl" placeholder="Tanggal" value="<?php echo $ref_hrbp[2];?>">
	</td>
    </tr>   
    <tr>
