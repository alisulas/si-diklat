...
<table class="table table-bordered table-condensed">
    ...
    <tr>
        ...
        <td class="left" colspan="3">
            <input type="text" name="alamat" class="text input-xxlarge" value="<?php echo (set_value('alamat')) ?
    ...
    <tr>
        ...
        <td class="left" colspan="3">
            <input type="text" name="telp" class="text input-medium" value="<?php echo (set_value('telp')) ?
