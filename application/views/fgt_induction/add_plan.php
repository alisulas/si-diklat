...
<table class="table table-bordered table-condensed">
    ...
    <tr>
        ...
        <td class="left">
            <input type="text" name="ref_user" placeholder="User">&nbsp;<input type="text" name="ref_memo"
                placeholder="No Memo">&nbsp;<input type="text" name="ref_tgl" id="ref_tgl" placeholder="Tanggal"><br>
            <input type="text" name="ref_rec" placeholder="Recruitment">&nbsp;<input type="text" name="ref_rec_memo"
                placeholder="No Memo">&nbsp;<input type="text" name="ref_rec_tgl" id="ref_rec_tgl"
                placeholder="Tanggal">
        </td>
    </tr>
    <tr>
