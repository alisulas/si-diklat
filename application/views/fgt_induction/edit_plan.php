...
<table class="table table-bordered table-condensed">
    ...
    <tr>
        ...
        <td class="left">
            <input type="text" name="ref_user" placeholder="User" value="<?php echo $ref[0]; ?>">&nbsp;<input
                type="text" name="ref_memo" placeholder="No Memo" value="<?php echo $ref[1]; ?>">&nbsp;<input
                type="text" name="ref_tgl" id="ref_tgl" placeholder="Tanggal" value="<?php echo $ref[2]; ?>"><br>
            <input type="text" name="ref_rec" placeholder="Recruitment" value="<?php echo $ref_rec[0]; ?>">&nbsp;<input
                type="text" name="ref_rec_memo" placeholder="No Memo" value="<?php echo $ref_rec[1]; ?>">&nbsp;<input
                type="text" name="ref_rec_tgl" id="ref_rec_tgl" placeholder="Tanggal"
                value="<?php echo $ref_rec[2]; ?>">
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td class="left">
            ...
            <a href="sarfas/list_lokasi" class="btn btn-success" target="_blank" style="float:right">Tambah Lokasi Baru
