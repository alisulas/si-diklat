...
<table class="table table-bordered table-condensed">
	...
	<td class="left">
	    <input type="text" name="tgl_mulai" class="text input-small" id="start_date"  value="<?php echo $agenda['tgl_mulai']; ?>"/> -
            <input type="text" name="tgl_selesai" class="text input-small" id="end_date"  value="<?php echo $agenda['tgl_selesai']; ?>"/>	
	</td>
    </tr>
    <tr>
	...
	<td valign="top">Tempat <span style="color:red">*</span></td>
        <td>
            ...
            <div id="other">
            <br><input type="text" name="tempat" class="text" placeholder="Nama Tempat"  value="<?php echo $agenda['tempat']; ?>">
 ...
 <script type="text/javascript">
        $(this).ready( function() {
            ...
            select:
                ...
                {
                    $("#result").append(
                        "<tr><td><input type='hidden' value='"+ ui.item.id + "' name='pengajar[]'/>"+ ui.item.value + "<a href='#' class='remove_trainer'><i class='icon-remove'></i></a></td><tr>"
                    );
		    $("#trainer").hide();
		    $("#null_trainer").remove();
		    $("#add_trainer").show();
            ...
            select:
                ...
                if(ui.item.id!=0)
                {
                    $("#result_program").append(
                        "<tr><td><input type='hidden' value='"+ ui.item.id + "' name='pelatihan'/>"+ ui.item.value + "<a href='#' class='remove_program'><i class='icon-remove'></i></a></td><tr>"
                    );
		    $("#program").hide();
		    $("#null_program").remove();
                }
            ...
            select:
                ...
                if(ui.item.id!=0)
                {
                    $("#result_provider").append(
                        "<tr><td><input type='hidden' value='"+ ui.item.id + "' name='provider'/>"+ ui.item.value + "<a href='#' class='remove_provider'><i class='icon-remove'></i></a></td><tr>"
                    );
		    $("#provider").hide();
