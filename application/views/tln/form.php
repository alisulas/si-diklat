                    ...
                    <td>
                        <div class="btn-group" data-toggle-name="memo_permintaan" data-toggle="buttons-radio">
                            <button type="button" class="btn btn-info" value="1"
                                onclick="changeVal('memo_permintaan')">Ada</button>
                            <button type="button" class="btn btn-info" value="0"
                                onclick="changeVal('memo_permintaan')">Tidak Ada</button>
                        </div>
                ...
                <tr>
                    ...
                    <td>
                        <div class="btn-group" data-toggle-name="persetujuan_hrbp" data-toggle="buttons-radio">
                            <button type="button" class="btn btn-info" value="1"
                                onclick="changeVal('persetujuan_hrbp')">Disetujui</button>
                            <button type="button" class="btn btn-info" value="0"
                                onclick="changeVal('persetujuan_hrbp')">Tidak Disetujui</button>
                        </div>
                        <span id="msg_act8"></span>
                ...
                <tr>
                    ...
                    <td>
                        <div class="btn-group" data-toggle-name="ket_toeic" data-toggle="buttons-radio">
                            <button type="button" class="btn btn-info" value="1"
                                onclick="changeVal('ket_toeic')">Memenuhi</button>
                            <button type="button" class="btn btn-info" value="0" onclick="changeVal('ket_toeic')">Tidak
                                Memenuhi</button>
                        </div>
                        <span id="msg_act8"></span>
                ...
                <tr>
                    ...
                    <td>
                        <div class="btn-group" data-toggle-name="spd" data-toggle="buttons-radio">
                            ...
                            <button type="button" class="btn btn-info" value="0" onclick="changeVal('spd')">Tidak
                                Ada</button>
                        </div>
                        <span id="msg_act8"></span>
                ...
                <tr>
                    ...
                    <td>
                        <div class="btn-group" data-toggle-name="log_provider" data-toggle="buttons-radio">
                            <button type="button" class="btn btn-info" value="1"
                                onclick="changeVal('log_provider')">Ada</button>
                            <button type="button" class="btn btn-info" value="0"
                                onclick="changeVal('log_provider')">Tidak Ada</button>
                        </div>
                        <span id="msg_act8"></span>
                ...
                <tr>
                    ...
                    <td>
                        <div class="btn-group" data-toggle-name="sp" data-toggle="buttons-radio">
                            ...
                            <button type="button" class="btn btn-info" value="0" onclick="changeVal('sp')">Tidak
                                Ada</button>
                        </div>
                        <span id="msg_act8"></span>
        ...
        <div class="tab-pane" id="tab3">
            <table class="table table-bordered table-condensed">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="tgl_pengiriman_reminder" class="text input-medium"
                            id="tgl_pengiriman_reminder"
                ...
                <tr>
                    ...
                    <td>
                        ...
                        if ($bkt == 'edit') {
                        ?>
                        <input type="checkbox" name="bukti_kehadiran[]" value="Absensiedit"
                            <?php cek_bk('Absensi', $bukti_kehadiran) ?>>&nbsp;Absensi<br>
                        <input type="checkbox" name="bukti_kehadiran[]" value="Sertifikat"
                            <?php cek_bk('Sertifikat', $bukti_kehadiran) ?>>&nbsp;Sertifikat<br>
                        <input type="checkbox" name="bukti_kehadiran[]" value="Name Tag"
                            <?php cek_bk('Name Tag', $bukti_kehadiran) ?>>&nbsp;Name Tag<br>
                        <?php
                        } else { ?>
                ...
                <tr>
                    ...
                    <td>
                        <div class="btn-group" data-toggle-name="feedback" data-toggle="buttons-radio">
                            <button type="button" class="btn btn-info" value="1"
                                onclick="changeVal('feedback')">Ada</button>
                            <button type="button" class="btn btn-info" value="0" onclick="changeVal('feedback')">Tidak
                                Ada</button>
                        </div>
                        <span id="msg_act8"></span>
...
<div class="form-actions">
    <a href="tln/index" class="btn"><i class="icon-hand-left"></i> Kembali ke list</a>&nbsp;<button
