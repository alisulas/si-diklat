...
<form action="course/search" method="POST">
    ...
    <table id="nam">
        ...
        <tr>
            <td><input type="text" name="course_name" placeholder="Masukkan nama pelatihan" /><button
                    class="btn btn-primary" type="submit">Cari</button></td>
        </tr>
    </table>
    ...
    <table id="tmp">
        ...
        <tr>
            <td><input type="text" name="location" placeholder="Masukkan Tempat pelatihan" /><button
                    class="btn btn-primary" type="submit">Cari</button></td>
        </tr>
    </table>
    <hr>
