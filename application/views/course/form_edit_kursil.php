...
<table class="table table-bordered table-condensed">
    ...
    <tr>
	<td valign="top" width="200">Persyaratan</td>
	<td class="left">
...
<table class="table table-bordered table-condensed">
    <tr><td colspan="2"><b>ANGGARAN</b></td></tr>
    <tr>
	<td valign="top" width="200">Anggaran Pelatihan /  Workshop </td>
	<td class="left">
...
<table class="table table-bordered table-condensed">
    <tr><td colspan="2"><b>PENGAJAR</b></td></tr>
    <tr>
	<td valign="top" width="200">Data Pengajar</td>
	<td class="left">
...
<table class="table table-bordered table-condensed">
    <tr><td colspan="2"><b>JADWAL PEMBELAJARAN</b></td></tr>
    <tr>
	<td valign="top" width="200">Jadwal Pembelajaran</td>
	<td class="left">
	   <?php echo $edit_jadwal;?>
	</td>
    </tr>
</table>

<div class="form-actions">
    <a class="btn" href="course/kursil/<?php echo $course_id;?>"><i class="icon-hand-left"></i> Cancel</a>
