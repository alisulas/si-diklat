...
<table class="table table-bordered table-condensed">
    <tr>
        ...
        <td class="left">
            <input type="text" name="pic" class="text" value="<?php echo (set_value('pic')) ?
    ...
    <tr>
        <td>Jenis</td>
        <td class="left">
            <input type="text" name="jenis" class="text" value="<?php echo (set_value('jenis')) ?
    ...
    <tr>
        <td>SP</td>
        <td class="left">
            <input type="text" name="sp" class="text" id="sp" value="<?php echo (set_value('sp')) ?
    ...
    <tr>
        <td>SPK</td>
        <td class="left">
            <input type="text" name="spk" class="text" id="spk" value="<?php echo (set_value('spk')) ?
