...
<table class="table table-striped">
    ...
    <tr>
        ...
        <td><input type="text" name="tgl_terima" value="<?php echo $tgl_terima; ?>" id="tgl_terima"
                class="input input-medium"></td>
    </tr>
    <tr>
        <td>Penerima</td>
        <td><input type="text" name="penerima" value="<?php echo $penerima; ?>" class="input input-medium"></td>
    </tr>
    <tr>
        <td>Ket</td>
