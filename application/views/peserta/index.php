...
<table border="0" class="tablerow1">
    ...
    <tr>
        ...
        <td>Jumlah Peserta Diundang</td>
        <td>: <?php echo $jml_peserta; ?> Orang</td>
    </tr>
    <tr>
        <td>Jumlah Peserta Konfirmasi</td>
        <td>: <?php echo $jml_konfirmasi; ?> Orang</td>
    </tr>
    <tr>
...
<a href="#add" data-toggle="modal"> <button class="btn btn-primary" type="submit"><i
            class="icon icon-plus-sign icon-white">&nbsp;</i>Tambah Dari Master Data Pekerja</button></a>
<a href="#add_manual" data-toggle="modal"> <button class="btn btn-primary" type="submit"><i
            class="icon icon-plus-sign icon-white">&nbsp;</i>Tambah</button></a>
...
<a class="btn" href="fgt_pelatihan/list_check" data-original-title=""><i class="icon-hand-left"></i> Kembali ke list</a>
<div class="modal fade in" id="add" style="display:none;">
    ...
    <div class="modal-body">
        ...
        <a href="pekerja/add" class="btn btn-success" target="_blank" style="float:right">Tambah Pekerja Baru &nbsp;<i
                class="icon icon-pencil icon-white"></i></a>
    </div>
    <div class="modal-footer">

        <button class="btn btn-primary" type="submit">Simpan</button><a href="#" class="btn"
            data-dismiss="modal">Keluar</a>
    </div>
    <?php echo form_close(); ?>
</div>
...
<div class="modal fade in" id="upload" style="display:none; width: 250px">
    ...
    <div class="modal-body">
        ...
        <?php echo form_open_multipart('peserta/do_upload/' . $course_id); ?>
...
<?php echo $edit_peserta; ?>
<?php echo $history_peserta; ?>
...
$(this).ready(function() {
    $("#peserta").autocomplete({
        ...
        source: function(req, add) {
            $.ajax({
                url: "<?php echo base_url(); ?>index.php/peserta/lookup_pekerja",
                dataType: 'json',
                type: 'POST',
                data: req,
        ...
        select: function(event, ui) {
            if (ui.item.id != 0) {
                $("#result").append(
                    "<tr><td><input type='hidden' value='" + ui.item.id + "' name='nopek[]'/>" +
                    ui.item.value +
                    "&nbsp;<input type='text' name='email[]' placeholder='Email'>&nbsp;<a href='#' class='remove_peserta'><span class='label label-important'>Hapus</span></i></a></td></tr>"
                );
                $("#peserta").hide();
                $("#null_peserta").remove();
                $("#add_peserta").show();
