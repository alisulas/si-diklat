...
<table border="0" class="tablerow1">
	...
	<tr><td>Tanggal Pelaksanaan</td><td>: <?php echo $tgl_pelaksanaan;?></td></tr>
        ...
        <tr>
            ...
            <td>Jumlah Peserta Diundang</td><td>: <?php echo $jml_peserta; ?> Orang</td>            
              </tr>    
        <tr>
            <td>Jumlah Peserta Konfirmasi</td><td>: <?php echo $jml_konfirmasi; ?> Orang</td>
        </tr>
        <tr>
            <td>Jumlah Peserta Hadir</td><td>: <?php echo $jml_hadir; ?> Orang</td>
        </tr>
...
<?php echo form_open_multipart($action);?>
 <table border="0" id="result" class="table table-striped">                
	...
	<a id="add_peserta" class="btn btn-mini btn-inverse">Tambah</a>
        ...
        <a href="pekerja/add" class="btn btn-success" target="_blank" style="float:right">Tambah Pekerja Baru &nbsp;<i class="icon icon-pencil icon-white"></i></a>
  </div>
