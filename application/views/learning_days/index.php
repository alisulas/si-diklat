...
<p>
 ...
 <form action="learning_days/index" method="POST">
     <select name="list">
 ...
 <a href="learning_days/add_ld"> <button class="btn btn-success">Tambah</button></a>
 <p>
    <?php echo $pagination;?>
    <?php echo $content;?>
    <?php echo $pagination;?>
...
<?php echo form_open_multipart('learning_days/do_upload');?>
