...
<div id="pencarian">
    ...
    <table>
        ...
        <tr>
            ...
            <td><input type="text" name="no_tiket" class="input input-small" placeholder="No Tiket"><input type="submit"
                    class="btn btn-primary" value="Cari"></td>
        </tr>
        <tr>
            <td><span class="label label-inverse">Tanggal</span></td>
            <td><input type="text" name="tgl_awal" id="tgl_awal" placeholder="Dari"> - <input type="text"
                    name="tgl_selesai" id="tgl_selesai" placeholder="Sampai"><input type="submit"
                    class="btn btn-primary" value="Cari"></td>
        </tr>
    </table>
...
$(this).ready(function() {
    $("#program").autocomplete({
        ...
        source: function(req, add) {
            $.ajax({
                url: "<?php echo base_url(); ?>index.php/dashboard/lookup_pelatihan",
                dataType: 'json',
                type: 'POST',
                data: req,
        ...
        select: function(event, ui) {
            if (ui.item.id != 0) {
                ...
                $("#result_program").append(
                    "<input type='hidden' value='" + ui.item.id + "' name='kd_pelatihan'/>" + ui
                    .item.value +
                    "&nbsp;<span class='label label-inverse'>Batch</span><input type='text' name='batch' class='input input-mini'><button class='btn btn-primary' type='submit'>Cari</button> "
                );
                $("#program").hide();
            }
        }
