...
?>
    ...
    <tr>
        <td>
            <input type="submit" value="simpan" class="btn btn-primary"> <a href="sertifikat/list_pekerja" class="btn"><i class="icon-backward"></i> Back</a>
        </td>
        <td></td>
    </tr>
</table>
...
<script type="text/javascript">
        $(this).ready( function() {
            ...
            select:
                ...
                {
                    $("#result").append(
                        "<tr><td><input type='hidden' value='"+ ui.item.id + "' name='jabatan'/>"+ ui.item.value + "<a href='#' class='remove_jabatan'><i class='icon-remove'></i></a></td><tr>"
                    );
		    $("#jabatan").hide();
		    $("#null_jabatan").remove();
		    $("#add_jabatan").show();
