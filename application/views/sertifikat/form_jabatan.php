...
<table class="table table-bordered table-condensed">
    ...
    <tr>
		...
		<tr><td><strong>Data Sertifikat</strong></td></tr>
		<?php echo $sertifikat;?>
	    </table>
    ...
    <tr>
        <td>
            <input type="submit" value="simpan" class="btn btn-primary"> <a href="sertifikat/list_jabatan" class="btn"><i class="icon-backward"></i> Back</a>
        </td>
        <td></td>
    </tr>
</table>
...
<script type="text/javascript">
        $(this).ready( function() {
            ...
            select:
                ...
                {
                    $("#result").append(
                        "<tr><td><input type='hidden' value='"+ ui.item.id + "' name='sertifikat[]'/>"+ ui.item.value + "<a href='#' class='remove_sertifikat'><i class='icon-remove'></i></a></td><tr>"
                    );
		    $("#sertifikat").hide();
