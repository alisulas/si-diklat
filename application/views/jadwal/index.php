...
<script type="text/javascript" src="assets/timepicker/jquery.timePicker.js"></script>
 <style type="text/css" media="all">@import "assets/timepicker/timePicker.css"</style>
...
<br>
    ...
    <table class="table table-condensed">
        ...
        <tr>
            ...
            <td>
               <div><input type="text" name="waktu1" id="time3" size="10" value="08:00" style="width:45px"/> - <input type="text" name="waktu2" id="time4" size="10" value="09:00" style="width:45px"/></div>
            </td>
        </tr>
                <tr>
            <td>
