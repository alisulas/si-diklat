...
<table class="table table-bordered">
    ...
    <tr>
        ...
        <td class="left">
            <input type="text" name="nama_program" class="text" value="<?php echo $carpar['nama_program']; ?>" />
        </td>
    </tr>
    ...
    <tr>
        ...
        <td class="left">
            <input type="text" name="kode_program" class="text" value="<?php echo $carpar['kode_program']; ?>" />
        </td>
    </tr>
    ...
    <tr>
        ...
        <td class="left">
            <input type="text" name="email_pic" class="text" value="<?php echo $carpar['email_pic']; ?>" />
        </td>
    </tr>
    ...
    <tr>
        ...
        <td class="left">
            <input type="text" name="temuan" class="text" value="<?php echo $carpar['temuan']; ?>" />
        </td>
    </tr>
