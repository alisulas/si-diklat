...
<table class="table table-striped">
    ...
    <tr>
        ...
        <td><input type="radio" name="obs10" value="Ya">Ya &nbsp;<input type="radio" name="obs10" value="Tidak">Tidak
        </td>
    ...
    <tr>
        ...
        <td><input type="radio" name="obs11" value="Ya">Ya &nbsp;<input type="radio" name="obs11" value="Tidak">Tidak
        </td>
    ...
    <tr>
        ...
        <td><input type="radio" name="obs12" value="Ya">Ya &nbsp;<input type="radio" name="obs12" value="Tidak">Tidak
        </td>
    ...
    <tr>
        ...
        <td><input type="radio" name="obs13" value="Ya">Ya &nbsp;<input type="radio" name="obs13" value="Tidak">Tidak
        </td>
    ...
    <tr>
        ...
        <td><input type="radio" name="obs14" value="Ya">Ya &nbsp;<input type="radio" name="obs14" value="Tidak">Tidak
        </td>
    ...
    <tr>
        ...
        <td><input type="radio" name="obs15" value="Ya">Ya &nbsp;<input type="radio" name="obs15" value="Tidak">Tidak
        </td>
    ...
    <tr>
        ...
        <td><input type="radio" name="obs16" value="Ya">Ya &nbsp;<input type="radio" name="obs16" value="Tidak">Tidak
        </td>
    ...
    <tr>
        ...
        <td><input type="radio" name="obs17" value="Ya">Ya &nbsp;<input type="radio" name="obs17" value="Tidak">Tidak
        </td>
    ...
    <tr>
        ...
        <td><input type="radio" name="obs18" value="Ya">Ya &nbsp;<input type="radio" name="obs18" value="Tidak">Tidak
        </td>
    ...
    <tr>
        ...
        <td><input type="radio" name="obs19" value="Ya">Ya &nbsp;<input type="radio" name="obs19" value="Tidak">Tidak
        </td>
    ...
    <tr>
        ...
        <td><input type="radio" name="obs20" value="Ya">Ya &nbsp;<input type="radio" name="obs20" value="Tidak">Tidak
        </td>
...
$(this).ready(function() {
    $("#trainer").autocomplete({
        ...
        select: function(event, ui) {
            if (ui.item.id != 0) {
                $("#result").append(
                    "<tr><td><input type='hidden' value='" + ui.item.id + "' name='trainer'/>" +
                    ui.item.value +
        ...
        select: function(event, ui) {
            if (ui.item.id != 0) {
                $("#result_program").append(
                    "<tr><td><input type='hidden' value='" + ui.item.id + "' name='program'/>" +
                    ui.item.value +
