...
<table class="table table-bordered">
    ...
    <tr>
        ...
        <td><input type="radio" name="ket" value="Black List">Black List <input type="radio" name="ket"
                value="White List">White List </td>
    </tr>

</table>


<input type="button" id="tam" class="btn btn-success" value="Tambahan"
    onclick="$('#more').show('normal'),$('#tam').hide('normal')" />
<div id="more">
    ...
    <input type="button" class="btn btn-danger" value="Hapus"
        onclick="$('#more').hide('normal'),$('#tam').show('normal')" />
</div>
