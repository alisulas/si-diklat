...
<table class="table table-bordered">
    <tr>
        ...
        <td class="left">
            <input type="text" name="no" class="text" value="<?php echo (set_value('no')) ?
    ...
    <tr>
        ...
        <td class="left">
            <input type="text" name="date" class="text input-small" id="date_now" value="<?php echo (set_value('date')) ?
    ...
    <tr>
        ...
        <td class="left">
            <input type="text" name="education" class="text" value="<?php echo (set_value('education')) ?
    ...
    <tr>
        ...
        <td class="left">
            <input type="text" name="certification" class="text" value="<?php echo (set_value('certification')) ?
    ...
    <tr>
        ...
        <td class="left">
            <input type="text" name="job_experience" class="text" value="<?php echo (set_value('job_experience')) ?
    ...
    <tr>
        ...
        <td class="left">
            <input type="text" name="address" class="text input-xxlarge" value="<?php echo (set_value('address')) ?
    ...
    <tr>
        ...
        <td class="left">
            <input type="text" name="phone" class="text" value="<?php echo (set_value('phone')) ?
    ...
    <tr>
        ...
        <td class="left">
            <input type="text" name="fax" class="text" value="<?php echo (set_value('fax')) ?
    ...
    <tr>
        ...
        <td class="left">
            <input type="text" name="email" class="text" id="prependedInput" value="<?php echo (set_value('email')) ?
    ...
    <tr>
        ...
        <td class="left">
            <input type="text" name="website" class="text" value="<?php echo (set_value('website')) ?
    ...
    <tr>
        ...
        <td class="left">
            <input type="text" name="npwp_no" class="text" value="<?php echo (set_value('npwp_no')) ?
    ...
    <tr>
        ...
        <td class="left">
            <input type="text" name="birth_location" class="text" value="<?php echo (set_value('birth_location')) ?
																				set_value('birth_location') : $trainer['birth_location']; ?>" /> -
            <input type="text" name="birth_date" class="text input-small" id="date_birth" value="<?php echo (set_value('birth_date')) ?
    ...
    <tr>
        ...
        <td class="left">
            <input type="text" name="profession" class="text" value="<?php echo (set_value('profession')) ?
    ...
    <tr>
        ...
        <td class="left">
            <input type="text" name="association" class="text" value="<?php echo (set_value('association')) ?
    ...
    <tr>
        <td valign="top" colspan="3" align="center">
            <div align="center"><b>KELENGKAPAN DOKUMEN</b></div>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td class="left">
			...
			if ($trainer['doc_surat_pengantar'] == '') {
				echo  '<div class="btn btn-danger">Belum Tersedia</div>';
			} else {
				echo  '<a href="assets/uploads/trainer/' . $trainer['doc_surat_pengantar'] . '" class="btn btn-success">Download File</a>';
			}
    ...
    <tr>
        ...
        <td class="left">
			...
			if ($trainer['doc_npwp'] == '') {
				...
				echo  '<a href="assets/uploads/trainer/' . $trainer['doc_npwp'] . '" class="btn btn-success">Download File</a>';
			}
    ...
    <tr>
        ...
        <td class="left">
            <input type="file" name="doc_ktp" size="20" />
            <?php

			if ($trainer['doc_ktp'] == '') {
				echo  '<div class="btn btn-danger">Belum Tersedia</div>';
			} else {
				echo  '<a href="assets/uploads/trainer/' . $trainer['doc_ktp'] . '" class="btn btn-success">Download File</a>';
			}
    ...
    <tr>
        ...
        <td class="left">
            <input type="file" name="doc_kta" size="20" />
            <?php

			if ($trainer['doc_kta'] == '') {
				echo  '<div class="btn btn-danger">Belum Tersedia</div>';
			} else {
				echo  '<a href="assets/uploads/trainer/' . $trainer['doc_kta'] . '" class="btn btn-success">Download File</a>';
			}
    ...
    <tr>
        ...
        <td class="left">
            <input type="file" name="doc_ijazah" size="20" />
            <?php

			if ($trainer['doc_ijazah'] == '') {
				echo  '<div class="btn btn-danger">Belum Tersedia</div>';
			} else {
				echo  '<a href="assets/uploads/trainer/' . $trainer['doc_ijazah'] . '" class="btn btn-success">Download File</a>';
			}
    ...
    <tr>
        ...
        <td class="left">
            <input type="file" name="doc_sertifikat" size="20" />
            <?php

			if ($trainer['doc_sertifikat'] == '') {
				echo  '<div class="btn btn-danger">Belum Tersedia</div>';
			} else {
				echo  '<a href="assets/uploads/trainer/' . $trainer['doc_sertifikat'] . '" class="btn btn-success">Download File</a>';
			}
    ...
    <tr>
        <td valign="top">Form Kursil (Softcopy dan Hardcopy)</td>
        <td class="left">
            <input type="file" name="doc_form_kursil" size="20" />
            <?php

			if ($trainer['doc_form_kursil'] == '') {
				echo  '<div class="btn btn-danger">Belum Tersedia</div>';
			} else {
				echo  '<a href="assets/uploads/trainer/' . $trainer['doc_form_kursil'] . '" class="btn btn-success">Download File</a>';
			}
    ...
    <tr>
        ...
        <td class="left">
            <input type="file" name="doc_form_instruktur" size="20" />
            <?php

			if ($trainer['doc_form_instruktur'] == '') {
				echo  '<div class="btn btn-danger">Belum Tersedia</div>';
			} else {
				echo  '<a href="assets/uploads/trainer/' . $trainer['doc_form_instruktur'] . '" class="btn btn-success">Download File</a>';
			}
