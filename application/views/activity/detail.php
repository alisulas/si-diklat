...
<h3>Kelengkapan</h3>
<p>
    <a href="activity/edit/<?php echo $activity['plc_course_id'] ?>" class="btn btn-success"><i
            class="icon-wrench icon-white"></i> Edit</a>
</p>
<table class="table table-bordered table-condensed table-striped">
    <tr>
        <th width="10">No</th>
        <th>Aktifitas</th>
        <th width="130">Check</th>
    </tr>
    <tr>
        <td>1</td>
    ...
    <tr>
        <td>2</td>
        <td>Jadwal Program dan Nama Pengajar / activity Business Games (bila ada)</td>
        <td>
    ...
    <tr>
        <td>3</td>
        <td>Memo/Email Pencalonan peserta dari user (bila ada)</td>
        <td>
    ...
    <tr>
        <td>4</td>
        <td>Memo/ Nota Sarfas dan Uang Muka</td>
        <td>
    ...
    <tr>
        <td>5</td>
        <td>Memo/Surat/Fax Panggilan calon peserta dan pengajar, perjanjian / Penawaran activity (bila ada)</td>
        <td>
    ...
    <tr>
        <td>12</td>
        <td>Form Umpan Balik Program dari Peserta</td>
        <td>
    ...
    <tr>
        <td>15</td>
        <td>Rekap Peringkat dari Nilai Peserta</td>
        <td>
    ...
    <tr>
        <td>16</td>
        <td>Penyiapan Sertifikat (Mandotary Program & eLearning)</td>
        <td>
    ...
    <tr>
        <td>17</td>
        <td>Penutupan<br />a. Laporan Pelaksanaan<br />b. Peringkat & Nilai Peserta<br />c. Hadiah Peringkat Terbaik
        </td>
        <td>
    ...
    <tr>
        ...
        <td>Pertanggungjawaban (Copy SPD, copy Daftar Hadir Peserta dan Pengajar, Copy Kuitansi, Copy Surat Perintah,
            Berita Acara & Invoice, dll) - (bila ada)</td>
        <td>
