...
<table class="table table-bordered table-condensed table-striped">
    <tr>
        <th>No</th>
        <th>Aktifitas</th>
        <th width="130px">Check</th>
        <th>Ket.</th>
        <th width="100px">Update Terakhir</th>
    </tr>
    <tr>
        <td>1</td>
        <td>Memo / Email calon Peserta (RKAP3) dari Renbang</td>
        <td id="cont-act1">
    ...
    <tr>
        ...
        <td>
            <a href="jadwal/view/<?php echo $course_id; ?>" class="btn btn-info" target="_blank"><i
                    class="icon-search icon-white"></i> Lihat Jadwal</a>
        </td>
        <td></td>
        <td><?php echo $date_update; ?></td>
    </tr>
    ...
    <tr>
        ...
        <td>Nama Pengajar</td>
        <td>
            <a class="btn btn-info" data-toggle="modal" href="#pengajar"><i class="icon-user icon-white"></i> Daftar
                Pengajar</a>
        </td>
        <td></td>
        <td><?php echo $date_update; ?></td>
    ...
    <tr>
        <td>5</td>
        <td>Memo / Email Pencalonan Peserta dari User</td>
        <td id="cont-act5">
    ...
    <tr>
        <td>8</td>
        <td>Memo/Surat/Fax Pangilan Calon Peserta & Pengajar, Perjanjian / Penawaran Provider (bila ada)</td>
        <td id="cont-act7">
    ...
    <tr>
        <td>11</td>
        <td>Daftar Hadir dan Form Biodata</td>
        <td>
            <a class="btn btn-info" data-toggle="modal" href="#peserta"><i class="icon-user icon-white"></i> Daftar
                Peserta</a>
        </td>
        <td></td>
        <td></td>
    ...
    <tr>
        <td>13</td>
        <td>Flashdisk/CD berisi Materi Ajar untuk Peserta</td>
        <td>
    ...
    <tr>
        <td>15</td>
        <td>Form Upan Balik Program dari Peserta</td>
        <td>
    ...
    <tr>
        <td>17</td>
        <td>Rekap Umpan Balik Program dari Peserta</td>
        <td>
    ...
    <tr>
        <td>18</td>
        <td>Rekap Peringkat dan Nilai Peserta</td>
        <td>
    ...
    <tr>
        <td>19</td>
        <td>Penyiapan Sertifikat (Mandotary Program dan eLearning)</td>
        <td>
    ...
    <tr>
        <td>21</td>
        <td>Mengirim Hasil Umpan Balik Ke Renbang</td>
        <td id="cont-act20">
    ...
    <tr>
        <td>22</td>
        <td>Pertanggungjawaban (Copy SPD, Copy Daftar hadir Peserta dan Pengajar, Copy Kuitansi, Copy Surat Perintah,
            Berita Acara dan Invoice,dll)-(Bila ada)</td>
        <td id="cont-act21">
...
<div class="modal fade in" id="peserta" style="display:none">
    ...
    <div class="modal-footer">
        <a class="btn btn-info" href="peserta/view/<?php echo $course_id; ?>"><i class="icon-pencil icon-white"
                align="left"></i> Tambah Peserta</a>
        <a href="#" class="btn" data-dismiss="modal">Close</a>
    </div>
</div>
...
function changeVal(id) {
    ...
    send.done(function(data) {
        $("#msg_" + id).fadeIn('slow', function() {
            $(this).append("<span class='label label-success' id='s-ok-" + id +
                "'>Data telah tersimpan</span>");
            $("#img_" + id).remove();
