...
<table class="table table-condensed table-striped">
    ...
    <tr>
     ...
     <tr>
        ...
        <td>
            <input type="text" name="perguruan_tinggi" class="text" value="<?php echo $pkl['perguruan_tinggi']; ?>"/> &nbsp; Alamat &nbsp; : <input type="text" name="alamat_pt" class="text" value="<?php echo $pkl['alamat_pt']; ?>"/> &nbsp; Akreditasi &nbsp; : <?php echo $akreditasi_pt; ?>
        </td>
    </tr>
    <tr>
        <td>Fakultas <span style="color:red">*</span></td>
        <td>
            <input type="text" name="fakultas" class="text" value="<?php echo $pkl['fakultas']; ?>" /> Program Studi : <input type="text" name="prodi" class="text" value="<?php echo $pkl['prodi']; ?>" /> &nbsp; Akreditasi : <?php echo $akreditasi_prodi; ?>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>
            <input type="text" name="no_surat_pengantar" class="text" value="<?php echo $pkl['no_surat_pengantar']; ?>" />
    ...
    <tr>
        <td></td>
        <td>
            <input type="text" name="tgl_surat_pengantar" class="text" placeholder="Tanggal SP" id="datepicker4" value="<?php echo $pkl['tgl_surat_pengantar']; ?>"/>&nbsp; Tgl Surat Diterima &nbsp; :<input type="text" name="tgl_surat_pengantar_diterima" class="text" placeholder="Tanggal SP Diterima" id="datepicker5" value="<?php echo $pkl['tgl_surat_pengantar_diterima']; ?>"/>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>
            <input type="text" name="no_identitas_memo_ls" class="text" value="<?php echo $pkl['no_identitas_memo_ls']; ?>" />
        </td>
    </tr>
    <tr>
        ...
        <td>
            ...
            <input type="hidden" name="file_ecorr_fungsi2" value="<?php echo $pkl['file_ecorr_fungsi']; ?>"
        </td>
    </tr>
    <tr>
        <td>Tujuan Fungsi</td>
    ...
    <tr>
        <td>Tanggal Mulai</td>
        <td>
            <input type="text" id="datepicker" name="tgl_mulai" class="text" value="<?php echo $pkl['tgl_mulai']; ?>"/> &nbsp; Tanggal Selesai &nbsp; : <input type="text" id="datepicker1" name="tgl_selesai" class="text" value="<?php echo $pkl['tgl_selesai']; ?>"/>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td>
            ...
            <input type="hidden" name="file_memo_balasan_fungsi2" value="<?php echo $pkl['file_memo_balasan_fungsi']; ?>">
        </td>
    </tr>
    <tr>
        <td>No Ecorr Respon dari Fungsi </td>
        <td>
            <input type="text" name="no_ecorr_respon_fungsi" class="text" value="<?php echo $pkl['no_ecorr_respon_fungsi']; ?>" />
        </td>
    </tr>
    <tr>
        <td>Respon Persetujuan</td>
        <td>
            <input type="text" name="respon_persetujuan_pkl" class="text" value="<?php echo $pkl['respon_persetujuan_pkl']; ?>" />
        </td>
    </tr>
       <tr>
    ...
    <tr>
        ...
        <td>
            <input type="text" name="no_surat_ref_gabungan" class="text"  value="<?php echo $pkl['no_surat_ref_gabungan']; ?>"/>
        </td>
    </tr>
    <tr>
        <td>Tanggal Surat Keluar</td>
        <td>
            <input type="text" name="tgl_surat_keluar" class="text" id="datepicker2" value="<?php echo $pkl['tgl_surat_keluar']; ?>" />
        </td>
    </tr>
    <tr>
        <td>No Panggilan</td>
    ...
    <tr>
        ...
        <td>
            ...
            <input type="hidden" name="file_spkp2" value="<?php echo $pkl['file_spkp']; ?>"
        </td>
    </tr>
    <tr>
        <td>No SK PKL</td>
