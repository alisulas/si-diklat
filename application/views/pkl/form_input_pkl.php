...
<table class="table table-condensed table-striped">
    ...
    <tr>
        ...
        <td>
            <input type="text" name="perguruan_tinggi" class="text" /> &nbsp; Alamat &nbsp; : <input type="text"
                name="alamat_pt" class="text" /> &nbsp; Akreditasi &nbsp; : <select name="akreditasi_pt"
                class="input-mini">
                <option value="">-</option>
    ...
    <tr>
        ...
        <td>
            <input type="text" name="fakultas" class="text" /> Program Studi : <input type="text" name="prodi"
                class="text" /> &nbsp; Akreditasi : <select name="akreditasi_prodi" class="input-mini">
                <option value="">-</option>
                <option value="A">A</option>
                <option value="B">B</option>
                <option value="C">C</option>
    ...
    <tr>
        <td></td>
        <td>
            <input type="text" name="tgl_surat_pengantar" class="text" placeholder="Tanggal SP"
                id="datepicker4" />&nbsp; Tgl Surat Diterima &nbsp; :<input type="text"
                name="tgl_surat_pengantar_diterima" class="text" placeholder="Tanggal SP Diterima" id="datepicker5" />
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td>Tanggal Mulai</td>
        <td>
            <input type="text" id="datepicker" name="tgl_mulai" class="text" /> &nbsp; Tanggal Selesai &nbsp; : <input
                type="text" id="datepicker1" name="tgl_selesai" class="text" />
        </td>
    </tr>
    ...
    <tr>
        <td>No Panggilan</td>
        <td>
            <input type="text" name="no_panggilan" class="text" value="/PKL/K10460/2015-S8" /> &nbsp; <input type="file"
                name="file_panggilan" size="20">
        </td>
    </tr>
    <tr>
        <td>No SPKP</td>
        <td>
            <input type="text" name="no_spkp" class="text" value="/SP/PKL/K10460/2015-S8" /> &nbsp; <input type="file"
                name="file_spkp" size="20">
        </td>
    </tr>
    <tr>
        <td>No SK PKL</td>
        <td>
            <input type="text" name="no_surat_ket_pkl" class="text" value="/C1/PKL/K10460/2015-S8" /> &nbsp; <input
                type="file" name="file_surat_ket_pkl" size="20">
        </td>
    </tr>
    <tr>
        <td colspan="2">
