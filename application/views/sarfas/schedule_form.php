<p>
    ...
    <tr>
        ...
        <td>
            ...
            <input type="text" id="other" name="other" value="<?php echo $other_class; ?>" class="text" placeholder="Lainnya">
        </td>
    </tr>
    <tr>
        <td>
            Tanggal Mulai
                ...
                <td>
            	    <input type="text" id="date_start" name="start_date" class="text" value="<?php echo $kegiatan['start_date']; ?>">
        </td>
    </tr>
    <tr>
        <td>
            Tanggal Selesai
                ...
                <td>
            	    <input type="text" id="date_end" name="end_date" class="text" value="<?php echo $kegiatan['end_date']; ?>" />
        </td>
    </tr>
    <tr>
