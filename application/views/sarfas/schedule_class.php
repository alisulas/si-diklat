...
<table width="100%">
    ...
    <tr>
        ...
        <td>
            <div id='availability_result' style="width: 100px"></div>
        </td>
        <td>
            <div style="float: right"><?php echo $bulan_sekarang ?> </div>
        </td>
    </tr>
</table>
<?php
