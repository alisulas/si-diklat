...
<?php echo form_open($action) ?>
    <table>
        ...
        <tr>
            ...
            <td><select name="status"><option value="">-</option><option value="0">Belum Kembali</option><option value="1">Sudah Kembali</option></select></td>
        </tr>
        <tr>
           <td></td> <td><input type="submit" class="btn btn-primary" value="Cari"></td>
        </tr>
    </table>
