...
#Date { color: #0E4B9D;font-family:'BebasNeueRegular', Arial, Helvetica, sans-serif; font-size:20px; text-align:right; }

ul {color:#FB000C; margin-top: -9px; padding:0px; list-style:none; text-align:right; }
ul li { display:inline; font-size:3em; text-align:center; font-family:'BebasNeueRegular', Arial, Helvetica, sans-serif; }
                ...
                <div class="span12">
                   <div class="na">
                       <div class="navbar-inner">
                           <h1 style="text-align:center;color: #fff">This Week's Events</h1>
    </div>
</div>
                </div>
            </div>
