...
<table class="table table-condensed">
    ...
    <tr>
        ...
        <td class="left">
            ...
            <input type="text" id="laptop" style="display: none" placeholder="No Asset"
    ...
    <tr>
        ...
        <td><input type="text" name="tgl_peminjaman" id="tgl_pinjam"> s/d <input type="text" name="tgl_kembali"
                id="tgl_kembali"></td>
    </tr>
    <tr>
        <td>Catatan</td>
    ...
    <tr>
        <td><?php echo anchor('sarfas/list_peminjaman_laptop', 'Kembali', array('class' => 'btn')); ?>&nbsp;<input
                type="submit" value="Simpan" class="btn btn-primary"></td>
        <td></td>
    </tr>
</table>
        ...
        select: function(event, ui) {
            if (ui.item.id != 0) {
                $("#result").append(
                    ...
                    "' name='laptop[]'/><a href='laptop/detail/" + ui.item.id +
                    "' target='_blank'>" + ui.item.value +
                    "</a>&nbsp;<a href='#' class='remove_laptop'><span class='label label-important'>Hapus</span></a>"
                );
                $("#laptop").hide();
                $("#null_laptop").remove();
                $("#add_laptop").show();
