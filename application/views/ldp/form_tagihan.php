...
<table class="table table-bordered table-condensed">
    ...
    <tr>
        ...
        <td class="left" colspan="3">
            <input type="text" id="datepicker" name="tgl_mulai" class="text input-mini" /> s/d <input type="text"
                id="datepicker2" name="tgl_selesai" class="text input-mini" />
...
<table class="table table-bordered table-condensed" width="160">
    <tr>
        ...
        <td width="10">Cek</td><!-- <td width="100">No Dokumen</td><td>Upload</td> -->
    </tr>
    <tr>
