...
<table class="table table-bordered table-condensed">
    ...
    <tr>
        ...
        <td class="left" colspan="3">
            <input type="text" id="datepicker" name="tgl_mulai" value="<?php echo $tgl_mulai; ?>"
                class="text input-mini" /> s/d <input type="text" id="datepicker2" name="tgl_selesai"
                value="<?php echo $tgl_selesai; ?>" class="text input-mini" />
    ...
    <tr>
        ...
        <td class="left" colspan="3">
            <input type="text" id="datepicker3" name="tgl_tagihan_masuk" value="<?php echo $tgl_tagihan_masuk; ?>"
                class="text" />
    ...
    <tr>
        ...
        <td class="left" colspan="3">
            <input type="text" id="datepicker7" name="tgl_dokumen_lengkap" value="<?php echo $tgl_dokumen_lengkap; ?>"
                class="text" />
    ...
    <tr>
        ...
        <td class="left" colspan="3">
            <input type="text" id="datepicker4" name="tgl_tagihan_gsfa" value="<?php echo $tgl_tagihan_gsfa; ?>"
                class="text" />
    ...
    <tr>
        ...
        <td class="left" colspan="3">
            <input type="text" id="datepicker5" name="tgl_pembayaran" value="<?php echo $tgl_pembayaran; ?>"
                class="text" />
