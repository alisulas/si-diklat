...
<table class="table table-condensed table-striped">
    <tr>
        <td>Nama</td>
        <td>
            <input type="text" name="nama" class="text" value="<?php echo (set_value('nama')) ?
    ...
    <tr>
        <td>Jurusan</td>
        <td>
            <input type="text" name="jurusan" class="text" value="<?php echo (set_value('jurusan')) ?
    ...
    <tr>
        ...
        <td>
            ...
            ?>
            <input type="hidden" name="upload_surat_perguruan_tinggi2"
                value="<?php echo (set_value('upload_surat_perguruan_tinggi')) ?
    ...
    <tr>
        ...
        <td>
            ...
            ?>
            <input type="hidden" name="upload_memo_gsfa2"
                value="<?php echo (set_value('upload_memo_gsfa')) ?
    ...
    <tr>
        ...
        <td>
            ...
            ?>
            <input type="hidden" name="upload_memo_balasan_fungsi2"
                value="<?php echo (set_value('upload_memo_balasan_fungsi')) ?
    ...
    <tr>
        ...
        <td>
            ...
            ?>
            <input type="hidden" name="upload_surat_gsfa2"
                value="<?php echo (set_value('upload_surat_gsfa')) ?
    ...
    <tr>
        <td>Durasi</td>
        <td>
            <input type="text" name="durasi" class="text" value="<?php echo (set_value('durasi')) ?
    ...
    <tr>
        ...
        <td class="left">
            ...
            ?>
            <input type="hidden" name="upload_persyaratan2"
                value="<?php echo (set_value('upload_persyaratan')) ?
    ...
    <tr>
        ...
        <td class="left">
            ...
            ?>
            <input type="hidden" name="upload_laporan2"
                value="<?php echo (set_value('upload_laporan')) ?
    ...
    <tr>
        <td>Tujuan</td>
        <td><?php echo $this->editor->textarea("tujuan", (set_value('tujuan')) ? set_value('tujuan') : $pkl['tujuan']); ?>
        </td>
    </tr>
    <tr>
        <td>Referensi</td>
        <td><input type="text" name="ref" class="text" value="<?php echo (set_value('ref')) ?
...
<div class="form-actions">
    <button class="btn btn-primary"
        type="submit">Simpan</button>&nbsp;<?php echo anchor('sarfas/list_pkl', 'kembali', array('class' => 'btn')) ?>
</div>
<?php echo form_close(); ?>
        ...
        select: function(event, ui) {
            if (ui.item.id != 0) {
                $("#result").append(
                    ...
                    "' name='tempat_pelaksanaan'/>" + ui.item.value +
                    "<a href='#' class='remove_lokasi'><i class='icon-remove'></i></a></td><tr>"
                );
                $("#lokasi").hide();
                $("#null_lokasi").remove();
                $("#add_lokasi").show();
