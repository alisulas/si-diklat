    ...
    <div class="container" id="container">
        ...
        <div class="row">
            ...
            <div class="span12">
                ...
                <p class="footer">
                    <span style="float: left">Direkomendasikan menggunakan Browser &nbsp;<a
                            href="<?php echo site_url(); ?>assets/firefox/Firefox.exe">Firefox &nbsp; <span
                                class="label label-warning">Download Disini</span></a></span>
                    Tracking And Monitoring PCU &copy; <?php echo date('Y'); ?>
                </p>
            </div>
        </div>
    </div>
