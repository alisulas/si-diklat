...
<table class="table table-bordered table-condensed">
    <tr>
        ...
        <td>
            <input type="text" name="name" class="text"
                value="<?php echo (set_value('name')) ? set_value('name') : $certificate['name']; ?>">
            <?php form_error('name'); ?>
        </td>
    </tr>
    <tr>
        ...
        <td>
            <input type="text" name="nopek" class="text"
                value="<?php echo (set_value('nopek')) ? set_value('nopek') : $certificate['nopek']; ?>">
    ...
    <tr>
        ...
        <td>
            <input type="text" name="function" class="text"
                value="<?php echo (set_value('function')) ? set_value('function') : $certificate['function']; ?>">
    ...
    <tr>
        ...
        <td>
            <input type="text" name="certificate" class="text"
                value="<?php echo (set_value('certificate')) ? set_value('certificate') : $certificate['certificate']; ?>">
    ...
    <tr>
        ...
        <td>
            <input type="text" name="directorate" class="text"
                value="<?php echo (set_value('directorate')) ? set_value('directorate') : $certificate['directorate']; ?>">
    ...
    <tr>
        ...
        <td>
            ...
            <input type="hidden" name="status" id="status"
                value="<?php echo (set_value('status')) ? set_value('status') : $certificate['status']; ?>">
        </td>
    </tr>
    <tr>
        ...
        <td>
            <div id="boxes">
                <div id="box1">
                    <input type="text" name="expired" id="expired" class="text"
                        value="<?php echo (set_value('expired')) ? set_value('expired') : $certificate['expired']; ?>">
    ...
    <tr>
        ...
        <td>
            <input type="text" name="hr_area" class="text"
                value="<?php echo (set_value('hr_area')) ? set_value('hr_area') : $certificate['hr_area']; ?>">
