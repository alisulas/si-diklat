...
<?php echo $excel;?>    
 ...
 <form action="provider/index" method="POST">
     <select name="list">
            <option value="no" selected>No Provider</option>
            <option value="name">Nama</option>
            <option value="learning_competence">Kompetensi</option>    
     </select>
 <input type="text" name="provider_name" placeholder="Masukkan Nama Provider" />
