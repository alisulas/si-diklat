...
<table class="table table-bordered table-condensed">
    ...
    <tr>
        ...
        <td class="left" colspan="3">
            <input type="text" name="email" class="text" value="<?php echo (set_value('email')) ?
    ...
    <tr>
        ...
        <td class="left">
            <input type="text" name="akte_no" class="text" value="<?php echo (set_value('akte_no')) ?
        ...
        <td class="left">
            <input id="datepicker" type="text" name="akte_date" class="text" value="<?php echo (set_value('akte_date')) ?
    ...
    <tr>
        ...
        <td class="left">
            <input type="text" name="siup_no" class="text" value="<?php echo (set_value('siup_no')) ?
																		set_value('siup_no') : $provider['siup_no']; ?>" />
            <?php echo form_error('siup_no'); ?>
        </td>
        <td valign="top">Tanggal SIUP <span style="color:red">*</span></td>
        <td class="left">
            <input id="datepicker2" type="text" name="siup_date" class="text" value="<?php echo (set_value('siup_date')) ?
    ...
    <tr>
        ...
        <td class="left">
            <input type="text" name="pkp_no" class="text" value="<?php echo (set_value('pkp_no')) ?
																		set_value('pkp_no') : $provider['pkp_no']; ?>" />
            <?php echo form_error('pkp_no'); ?>
        </td>
        <td valign="top">Tanggal SPPKP <span style="color:red">*</span></td>
        <td class="left">
            <input id="datepicker3" type="text" name="pkp_date" class="text" value="<?php echo (set_value('pkp_date')) ?
