...
<p>
    <a href="course/kursil/<?php echo $course_id; ?>" class="btn"><i class="icon icon-hand-left"></i>Kembali ke
        kursil</a>
</p>
    ...
    <div class="modal-body">
        ...
        <table class="table table-condensed table-bordered">
            <tr>
                ...
                <th width="200">Pengajar</th>
            </tr>
            <tr>
                <td>07.30 - 08.00</td>
                <td><?php echo form_input('t1'); ?></td>
                <td><?php echo $tr1; ?></td>
            </tr>
            <tr>
                <td>08.00 - 08.45</td>
                <td><?php echo form_input('t2'); ?></td>
                <td><?php echo $tr2; ?></td>
            </tr>
            <tr>
                <td>08.45 - 09.30</td>
                <td><?php echo form_input('t3'); ?></td>
                <td><?php echo $tr3; ?></td>
            </tr>
            <tr>
                <td>09.30 - 09.45</td>
                <td><?php echo form_input('t4'); ?></td>
                <td><?php echo $tr4; ?></td>
            </tr>
            <tr>
                <td>09.45 - 10.30</td>
                <td><?php echo form_input('t5'); ?></td>
                <td><?php echo $tr5; ?></td>
            </tr>
            <tr>
                <td>10.30 - 11.15</td>
                <td><?php echo form_input('t6'); ?></td>
                <td><?php echo $tr6; ?></td>
            </tr>
            <tr>
                <td>11.15 - 12.00</td>
                <td><?php echo form_input('t7'); ?></td>
                <td><?php echo $tr7; ?></td>
            </tr>
            <tr>
                <td>12.00 - 13.00</td>
                <td><?php echo form_input('t8'); ?></td>
                <td><?php echo $tr8; ?></td>
            </tr>
            <tr>
                <td>13.00 - 13.45</td>
                <td><?php echo form_input('t9'); ?></td>
                <td><?php echo $tr9; ?></td>
            </tr>
            <tr>
                <td>13.45 - 14.30</td>
                <td><?php echo form_input('t10'); ?></td>
                <td><?php echo $tr10; ?></td>
            </tr>
            <tr>
                <td>14.30 - 15.15</td>
                <td><?php echo form_input('t11'); ?></td>
                <td><?php echo $tr11; ?></td>
            </tr>
            <tr>
                <td>15.15 - 15.30</td>
                <td><?php echo form_input('t12'); ?></td>
                <td><?php echo $tr12; ?></td>
            </tr>
            <tr>
                <td>15.30 - 16.15</td>
                <td><?php echo form_input('t13'); ?></td>
                <td><?php echo $tr13; ?></td>
            </tr>
            <tr>
                <td>16.15 - 17.00</td>
                <td><?php echo form_input('t14'); ?></td>
                <td><?php echo $tr14; ?></td>
            </tr>
        </table>
        </p>
...
function editSchedule(id2, id1) {
	...
	<table class="table"><tr><td width="100">Minggu ke </td><td>' + id1 + '</td></tr><tr><td>Hari ke </td><td>' + d +
        '</td></tr></table></p>'
    );
}
</script>
        ...
        select: function(event, ui) {
            if (ui.item.id != 0) {
                $("#result").append(
                    ...
                    "' name='trainer[]'/>" + ui.item.value + "</td><tr>"
                );
            }
        }
    });
