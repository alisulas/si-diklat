...
<table class="table table-condensed">
    ...
    <tr>
        <td class="judul">TPA</td>
        <td><?php echo $tb['tpa'] ?></td>
        <td class="judul">CP universitas</td>
        <td><?php echo $tb['cp_universitas'] ?></td>
    </tr>
    <tr>
        <td class="judul">TOEFL/IELTS</td>
        <td><?php echo $tb['toefl'] ?></td>
        <td class="judul">Email Universitas</td>
        <td><?php echo $tb['email_universitas'] ?></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td class="judul">Ijazah/SKL</td>
        <td><?php get_download($tb['ijazah']) ?></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td class="judul">GPA/IPK Akhir</td>
        <td><?php echo $tb['ipk_akhir'] ?></td>
    </tr>
    <tr>
