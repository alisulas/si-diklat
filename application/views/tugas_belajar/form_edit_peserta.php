...
<table class="table table-condensed">
    ...
    <tr>
        <td>TPA</td>
        <td><input type="text" name="tpa" value="<?php echo $tb['tpa'] ?>"></td>
        <td>CP universitas</td>
        <td><input type="text" name="cp_universitas" value="<?php echo $tb['cp_universitas'] ?>"></td>
    </tr>
    <tr>
        <td>TOEFL/IELTS</td>
        <td><input type="text" name="toefl" value="<?php echo $tb['toefl'] ?>"></td>
        <td>Email Universitas</td>
        <td><?php echo $email_universitas; ?></td>
    </tr>
    <tr>
        <td>Psikotest</td>
        <td><?php echo $psikotest; ?></td>
        <td>Masa Study</td>
        <td><input type="text" name="masa_study_awal" class="input input-small" id="datepicker1"
                value="<?php echo $tb['masa_study_awal'] ?>"> s/d <input type="text" name="masa_study_akhir"
                value="<?php echo $tb['masa_study_akhir'] ?>" class="input input-small" id="datepicker2"></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>Ijazah/SKL</td>
        <td><input type="file" name="ijazah"><input type="hidden" value="<?php echo $tb['ijazah'] ?>"></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>GPA/IPK Akhir</td>
        <td><input type="text" name="ipk_akhir" value="<?php echo $tb['ipk_akhir'] ?>"></td>
    </tr>
    <tr>
...
<div class="form-actions">
    <button class="btn btn-primary"
        type="submit">Simpan</button>&nbsp;<?php echo anchor('tugas_belajar/index', 'kembali', array('class' => 'btn')) ?>
</div>
<?php echo form_close(); ?>
