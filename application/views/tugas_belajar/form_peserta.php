...
<table class="table table-condensed">
    ...
    <tr>
        ...
        <td><input type="text" name="cp_universitas"></td>
    </tr>
    <tr>
        <td>TOEFL/IELTS</td>
        <td><input type="text" name="toefl"></td>
        <td>Email Universitas</td>
        <td><select name="email_universitas">
                <option value="-">-</option>
                <option value="TBDN">TBDN</option>
                <option value="TBLN">TBLN</option>
            </select></td>
    </tr>
    <tr>
        <td>Psikotest</td>
        ...
        <td>Masa Study</td>
        <td><input type="text" name="masa_study_awal" class="input input-small" id="datepicker1"> s/d <input type="text"
                name="masa_study_akhir" class="input input-small" id="datepicker2"></td>
    </tr>
    <tr>
        <td>Mdeical Check Up</td>
        <td><input type="text" name="mcu"></td>
        <td>Status Keberangkatan</td>
        <td><select name="status_keberangkatan">
                <option value="-">-</option>
    ...
    <tr>
        ...
        <td><select name="jenjang_pendidikan">
                <option value="-">-</option>
    ...
    <tr>
        ...
        <td>GPA/IPK Akhir</td>
        <td><input type="text" name="ipk_akhir"></td>
    </tr>
    <tr>
