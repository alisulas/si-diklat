...
class Mdl_peserta_induction extends CI_Model{
    private $table='peserta_induction';
    ...
    function get_index($id_course)
    {
        ...
        $this->db->where('id_fgt_induction',$id_course);
    ...
    function add_excel_pekerja($dataarray) {
        for ($i = 0; $i < count($dataarray); $i++) {
            $data = array(
                'id_fgt_induction'=> $dataarray[$i]['id_fgt_induction'],
